...
from chiron_utils.utils import MessageDict, return_logger, serialize_message_dict
...
class BaselineBot(ABC):
    ...
    async def send_suggestion(self, message_dict: MessageDict, suggestion_type: str) -> None:
